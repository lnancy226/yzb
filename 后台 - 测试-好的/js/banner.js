...
function initData() {
    ...
    function requestTableData(){
        ...
        $.ajax({
            type: "put",
            url: "http://120.27.226.156:8080/roo-sys-web/adv/read/page",      //获取banner数据接口
    ...
    function addBanner(){
        ...
        function ProcessFile(e) {
            ...
            $.ajax({
                type: "post",
                url: "http://120.27.226.156:8080/roo-sys-web/image",    //上传图片的接口
                contentType: false,
                processData: false,
                file: file,
                dataType: "JSON",
...
function deleteRow(obj,id){
    ...
    $.ajax({
        type:"delete",
        url:"http://120.27.226.156:8080/roo-sys-web/adv/"+id,
        contentType: "application/json;charset=utf-8",
        data:idData,
        dataType: "JSON",
        beforeSend: function (request) {
